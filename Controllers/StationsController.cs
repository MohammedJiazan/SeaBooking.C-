...
namespace sea_booking.Controllers
{
    public class StationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Country,Note")] Station station)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Country,Note")] Station station)
        {
            if (id != station.Id)
            {
                return NotFound();
